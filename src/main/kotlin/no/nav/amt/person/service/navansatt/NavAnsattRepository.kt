...
class NavAnsattRepository(
    ...
    fun get(id: UUID): NavAnsattDbo = template
        .query(
    ...
    fun get(navIdent: String): NavAnsattDbo? = template
        .query(
    ...
    fun upsert(navAnsatt: NavAnsattDbo): NavAnsattDbo = template.queryForObject(
